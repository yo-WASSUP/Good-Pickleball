...
class PlayerPositionVisualizer:
    ...
    def __init__(self, detections_path, output_dir=None, court_width=6.096, court_length=13.4112, fps=30):
        """
        ...
        Args:
            ...
            court_width: Pickleball court width in meters (default: 6.096m)
            court_length: Pickleball court length in meters (default: 13.4112m)
        """
        self.detections_path = detections_path
        self.court_width = court_width
        self.court_length = court_length
        self.court_margin_x = 2.0
        self.court_margin_y = 3.0
        ...
        self.img_height = 1341  # Image height (pixels)
        
        # Heatmap grid parameters
        self.heatmap_grid_size = (24, 52)  # Grid size (width grid count, length grid count)
    ...
    def _load_data(self):
        ...
        try:
            ...
            # Use standard pickleball court coordinates (13.4112m x 6.096m)
    ...
    def _draw_court(self, ax=None):
        """Draw a standard pickleball court."""
        if ax is not None:
            plt.sca(ax)
        ...
        kitchen_distance = 2.1336
        kitchen_top = net_y - kitchen_distance
        kitchen_bottom = net_y + kitchen_distance
        center_x = court_width / 2

        court_rect = plt.Rectangle((0, 0), court_width, court_length, fill=False, color=self.court_line_color, linewidth=4)
        plt.gca().add_patch(court_rect)
        plt.axhline(y=net_y, color=self.court_line_color, linestyle='--', linewidth=4)
        plt.plot([0, court_width], [kitchen_top, kitchen_top], self.court_line_color, linewidth=4)
        plt.plot([0, court_width], [kitchen_bottom, kitchen_bottom], self.court_line_color, linewidth=4)
        plt.plot([center_x, center_x], [0, kitchen_top], self.court_line_color, linewidth=4)
        plt.plot([center_x, center_x], [kitchen_bottom, court_length], self.court_line_color, linewidth=4)
